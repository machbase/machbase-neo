...
{: .warning }
> For handling TIMESTAMP typed column properly, option parameter `parseTime=true` is required.
...
```
mysql> update my_example set discount=1.234, plan=2.3456, code='0c275c5e-776f-457e-910e-0a95587d60c7', valid=1, memo='This is mysql brige test';
