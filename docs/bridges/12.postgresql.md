...
| `host`            | The host to connect to. Values that start with / are for unix domain sockets. | default is `host=127.0.0.1` |
...
## *TQL* for writing data on the PostgreSQL
...
## *TQL* for reading data from the PostgreSQL
