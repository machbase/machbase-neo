...
| OS         | Architecture   |  Download |
|:-----------|:---------------|:----------|
| macOS      | arm64          | [neow-fog-{{ site.latest_version }}-darwin-arm64.zip]({{ site.releases_url }}/download/{{ site.latest_version }}/neow-fog-{{ site.latest_version }}-darwin-arm64.zip)|
| macOS      | x64            | [neow-fog-{{ site.latest_version }}-darwin-amd64.zip]({{ site.releases_url }}/download/{{ site.latest_version }}/neow-fog-{{ site.latest_version }}-darwin-amd64.zip)|
